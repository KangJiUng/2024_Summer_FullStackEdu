...
// 채널정보 목록 화면 요청/응답 라우팅 메서드
// 호출 주소: http://localhost:5001/channel/list
// 호출 방식: GET 방식
// 응답 결과: list.ejs 뷰파일(채널정보 목록 웹페이지 /views/channel/list.ejs)
router.get("/list", async (req, res) => {
  res.render("channel/list.ejs");
});

// 채널정보 등록 화면 요청/응답 라우팅 메서드
// 호출 주소: http://localhost:5001/channel/create
// 호출 방식: GET 방식
// 응답 결과: create.ejs 뷰파일(채널정보 등록 웹페이지 /views/channel/create.ejs)
...
// 호출 주소: http://localhost:5001/channel/create
// 호출 방식: POST 방식
// 응답 결과: 채널정보 목록 페이지로 이동(http://localhost:5001/channel/list)
router.post("/create", function (req, res) {
  res.redirect("/channel/list");
});

// 채널정보 수정 화면 요청/응답 라우팅 메서드
// 호출 주소: http://localhost:5001/channel/modify
// 호출 방식: GET 방식
// 응답 결과: modify.ejs 뷰파일(채널정보 수정 웹페이지 /views/channel/modify.ejs)
