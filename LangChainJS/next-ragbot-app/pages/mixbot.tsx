              ...
              <div className="flex-grow ml-4">
                <div className="flex w-full">
                  <select
                    ...
                    className="flex w-[200px] border rounded-xl focus:outline-none focus:border-indigo-300 pl-4 h-10"
                  >
                  ...
                  <input
                    ...
                    className="flex ml-2 w-[80px] border rounded-xl focus:outline-none focus:border-indigo-300 pl-4 h-10"
                  />
